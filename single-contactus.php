<?php
/*
Template Name Posts: 联系我们(contact us)
*/
$page_id =  get_the_ID();
...
<!-- 				<li>
	...
	<div class="Column clearfix">
		...
		<script src="<?php bloginfo('template_directory'); ?>/js/jquery-1_002.js" type="text/javascript"></script>
...
间环节，立省30%，均符合国家环保标准，全责售后，全程无忧，真正让客户省时、省心、省力、省钱。
						...
						<div class="span4">
							<a onclick="openIframe('龙兵科技','http://j.map.baidu.com/4avbC');" href="javascript:void(0);">
								<img src="<?php bloginfo('template_directory'); ?>/images/580c5d233bff3.jpg" class="imgsize"></a>
						</div>
					</div>
				</div>
			</div>
...
主营住宅装饰装修和酒店、宾馆、会所、商场、展厅、办公楼等公共空间设计和施工，兼营家具制作、建筑材料、软装配饰一体化室内装饰服务。
						...
						<div class="span4">
							<a onclick="openIframe('龙兵科技','http://j.map.baidu.com/4avbC');" href="javascript:void(0);">
								<img src="<?php bloginfo('template_directory'); ?>/images/5923fa71bbf58.jpg" class="imgsize"></a>
						</div>
					</div>
				</div>
			</div>
...
发展方向。通过整合集团遍布全国的雄厚行业资源，我们将为客户提供全方位的项目规划，家居定制、软装陈设及室内设计与施工服务。
						...
						<div class="span4">
							<a onclick="openIframe('龙兵科技','http://j.map.baidu.com/4avbC');" href="javascript:void(0);">
								<img src="<?php bloginfo('template_directory'); ?>/images/5923f32fbae1b.jpg" class="imgsize"></a>
						</div>
					</div>
				</div>
			</div>
			<div class="ml20 mr20 mb20">
				<div class="container-fluid bgc p30">
					<div class="row-fluid">
						...
						<div class="span4">
							<a onclick="openIframe('龙兵科技','http://j.map.baidu.com/4avbC');" href="javascript:void(0);">
								<img src="<?php bloginfo('template_directory'); ?>/images/5997a6d674951.jpg" class="imgsize"></a>
						</div>
					</div>
				</div>
			</div>
...
参加各地项目考察与学习，充分了解设计市场、理论研究结合实地考察，切实加强设计师的项目整体规划与实际创作能力。
							...
							<p>
								<br></p>
							<p>
								<iframe src="<?php bloginfo('template_directory'); ?>/html/index.htm" style="width:560px;height:362px;" frameborder="0"></iframe>
							</p>
							<h3>
						...
						<div class="span4">
							<a onclick="openIframe('龙兵科技','http://j.map.baidu.com/4avbC');" href="javascript:void(0);">
								<img src="<?php bloginfo('template_directory'); ?>/images/5923f66ebbde2.jpg" class="imgsize"></a>
						</div>
					</div>
				</div>
			</div>

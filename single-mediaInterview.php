<?php
/*
Template Name Posts: 媒体专访 / mediaInterview
*/
$page_id =  get_the_ID();
	...
	<div class="Column clearfix">
		<div class="msgTitle"> <i class="line"></i>
			<div class="jiathis_style fr">
				...
				<div class="bdsharebuttonbox bdshare-button-style0-16" data-bd-bind="1542088214037">

					<a href="http://www.nnxyzs.com/detail/1179.html#" class="bds_more" data-cmd="more"></a>
					<a href="http://www.nnxyzs.com/detail/1179.html#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
					<a href="http://www.nnxyzs.com/detail/1179.html#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
					<a href="http://www.nnxyzs.com/detail/1179.html#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
					<a href="http://www.nnxyzs.com/detail/1179.html#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
					<a href="http://www.nnxyzs.com/detail/1179.html#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
		...
		<div class="Column-L">
			<div class="msgInfo">
				...
				<?php endif; wp_reset_query(); ?>
					<!-- <a href="http://www.nnxyzs.com/detail/1080.html" title="陈略专访视频" class="prev">上一篇:陈略专访视频</a>
					<a href="http://www.nnxyzs.com/detail/1181.html" title="周兵专访视频" class="next">下一篇:周兵专访视频</a> -->
			...
			<div class="Column-100 tc" -id="VideoPlay">
				<embed src="<?php echo get_post_meta($page_id, 'mediaInterview', true) ?>" quality="high" width="720" height="576" align="middle" allowscriptaccess="never" type="application/x-shockwave-flash"></div>
			<div class="hr30"></div>
			<div class="bigTitle">
				视频说明
				<i></i>
			...
			<div class="msgContent">
				...
				<?php if ($current_cat_ID == 15) { ?>
				<?php if (have_posts()) : ?>
				<?php while (have_posts()) : the_post(); ?>				
				<?php $post_id = $post->ID;?>
				<?php echo get_post_meta($post_id, '视频说明', true); ?>
				<?php endwhile; ?>
				<?php endif; wp_reset_query(); ?> 
				<?php } ?>
				南宁星艺装饰尚品设计院张旭设计师接受南宁电视台专访
			</div>
		</div>
		<div class="Column-R">
				...
				<form method="post" action="http://www.nnxyzs.com/Messages/add.html" onsubmit="return pubIndent_submit();">
					...
					<div class="table">
						...
						<div class="right">
							...
							<img src="<?php bloginfo('template_directory'); ?>/images/verify.html" width="60" height="30" class="margin-left-20" id="dea" onclick="reloadcode()" data-bd-imgshare-binded="1"></div>
					</div>
					<div class="table">
						<div class="left">&nbsp;</div>
						<div class="right">
...
function pubIndent_submit(){
	...
	return true;
			...
			<ul class="prMore clearfix">
				...
				<?php endif; wp_reset_query(); ?> 
<!-- 				<li>
					<a href="http://www.nnxyzs.com/detail/760.html" title="罗芳专访视频" target="_blank" class="imga">
						<img src="<?php bloginfo('template_directory'); ?>/images/58ca435b776c1.jpg" alt="罗芳专访视频" data-bd-imgshare-binded="1">
						<p>罗芳专访视频</p>
					</a>
				</li>
				<li id="end">
					<a href="http://www.nnxyzs.com/detail/1181.html" title="周兵专访视频" target="_blank" class="imga">
						<img src="<?php bloginfo('template_directory'); ?>/images/5abc951a60270.jpg" alt="周兵专访视频" data-bd-imgshare-binded="1">
						<p>周兵专访视频</p>
					</a>
				</li>
				<li>
					<a href="http://www.nnxyzs.com/detail/1179.html" title="张旭专访视频" target="_blank" class="imga">
						<img src="<?php bloginfo('template_directory'); ?>/images/5abc8a62ee8d5.jpg" alt="张旭专访视频" data-bd-imgshare-binded="1">
						<p>张旭专访视频</p>
					</a>
				</li>
				<li id="end">
					<a href="http://www.nnxyzs.com/detail/808.html" title="范建国专访视频" target="_blank" class="imga">
						<img src="<?php bloginfo('template_directory'); ?>/images/58e5b5413d10f.jpg" alt="范建国专访视频" data-bd-imgshare-binded="1">
						<p>范建国专访视</p>
					</a>
				</li> -->
			</ul>
...
$(document).ready(function(){
	...
	<div class="specListInd" id="specListInd">
		...
		<form method="post" action="http://www.nnxyzs.com/detail/1179.html?c=post&amp;f=setok&amp;module_id=132" onsubmit="return specListInd_submit();">
			<input type="hidden" id="tourl" name="tourl" value="goback">
			<input type="hidden" id="tomsg" name="tomsg" value="预约成功，我们将通过电话联系您！">

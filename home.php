...
<?php get_header(); ?>
									...
									<ul class="clone" style="height: 317px;">
										...
										<li id = "end">
											<a href="<?php the_permalink() ?>" title="<?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?>" target="_blank" class="imga">
												...
												<?php include( TEMPLATEPATH . '/thumbnail.php' ); ?>
												<div class="info"><?php $post_id =  get_the_ID(); echo get_post_meta($post_id, '设计理念', true);?>设计理念：空间以人为本，故设计来源于生活，体验生活，创造生活。应在体验的基础上用艺术的创作手法来创造一种和谐幸福的空间</div>
											</a>
											<div class="bg abs"></div>
											<div class="infobox abs">
												<div>
													<span><?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?></span>
													<?php $post_id =  get_the_ID(); echo get_post_meta($post_id, '公司职务', true);?>
												</div>
												<p>
													从业年限： <strong><?php $post_id =  get_the_ID(); echo get_post_meta($post_id, '从业年限',true);?></strong>
													年
												</p>
												<p>
													为 <strong><?php $post_id =  get_the_ID(); echo get_post_meta($post_id, '服务用户数', true);?></strong>
													户家庭设计过房子
												</p>
											</div>
										...
										<li>
											...
											<div class="infobox abs">
												...
												<p>
													从业年限： <strong><?php $post_id =  get_the_ID(); echo get_post_meta($post_id, '工作经验', true);?></strong>
													年
												</p>
												<p>
													为 <strong><?php $post_id =  get_the_ID(); echo get_post_meta($post_id, '服务人数', true);?></strong>
													户家庭设计过房子
												</p>
											</div>
											<a class="btn ac btn1" href="<?php the_permalink() ?>">查看案例</a>
									...
									<ul class="clone" style="height: 317px;">
										...
										<li id = "end">
											...
											<div class="infobox abs">
												<div>
													<span><?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?></span>
													<?php echo get_post_meta($post_id, '公司职务', false);?>
												</div>
												<p>
													从业年限： <strong><?php $post_id =  get_the_ID(); echo get_post_meta($post_id, '工作经验', true);?></strong>
													年
										...
										<li>
											...
											<div class="infobox abs">
												<div>
													<span><?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?></span>
													<?php $post_id =  get_the_ID(); echo get_post_meta($post_id, '公司职务', false);?>
												</div>
												<p>
													从业年限： <strong><?php $post_id =  get_the_ID(); echo get_post_meta($post_id, '工作经验', true);?></strong>
													年
			...
			?>
				<li>
					<a href="<?php the_permalink() ?>" title="<?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?>" target="_blank" class="fl">
						<!-- <img src="<?php bloginfo('template_directory'); ?>/images/5b4064f81a2e2.jpg" alt="<?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?>"> -->
						<?php include( TEMPLATEPATH . '/thumbnail.php' ); ?>
					</a>
	...
	<div class="Column">
		<div class="ibTitle iHouse_tt">
			...
			<h3 style="background:url(<?php bloginfo('template_directory'); ?>/images/zjian.png)no-repeat;">在建工地/BUILDINGS</h3>
		</div>
		<ul class="iHouse clearfix">
			<?php $count = 0; ?>
			<?php global $post; if (have_posts()) : ?>
			...
			<li>
				<a href="<?php the_permalink(); ?>" title="<?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?>" target="_blank" class="fl">
					<!-- <img src="<?php bloginfo('template_directory'); ?>/images/586764d179f26.jpg" alt="<?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?>"> -->
					<?php include( TEMPLATEPATH . '/thumbnail.php' ); ?>
				</a>
				<a href="<?php the_permalink(); ?>" title="<?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?>" target="_blank" class="tt f14"><?php echo mb_strimwidth(get_the_title(), 0, 16,''); ?></a>
				<p style="line-height:45px;">
	...
	<div class="Column clearfix">
		<div class="iIndent clearfix">
			...
			<form method="post" action="<?php bloginfo('template_directory'); ?>/cooperation/add.php" onsubmit="return iIndent_submit();">
						...
						<div>
							<table cellspacing="0" cellpadding="0">
								<tbody>
									<tr>
										<td>
											<input type="text" class="input-text" name="topic" id="addr" style="width:218px;"></td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div>
							<table cellspacing="0" cellpadding="0">
								<tbody>
									<tr>
										<td>
											<input type="text" class="input-text" name="acreage" id="area" style="width:218px;"></td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<div class="table">
					...
					<div class="right">
						...
						<img src="<?php bloginfo('template_directory'); ?>/images/verify.png" class="margin-left-20" id="de" onclick="reloadcode()" width="60" height="30">
					</div>
				</div>
			</form>
		</div>

	...
	$.fn.lavaLamp = function(o) {
		...
		return this.each(function() {
			...
			$li.not(".back").hover(function() {
				o.vertical ? move1(this) : move(this);
			}, noop);
			$(this).hover(noop, function() {
				o.vertical ? move1(curr) : move(curr);
			});
			me.hover(noop, function() {
				o.vertical ? move1(curr) : move(curr);
			}).trigger("mouseleave");
			$li.click(function(e) {
				setCurr(this);
			...
			function setCurr(el) {
				var cs = o.vertical ? "{top:" + el.offsetTop + "px,height:" + el.offsetHeight + "px}" : "{left:" + el.offsetLeft + "px,width:" + el.offsetWidth + "px}";
				$back.css(cs);
				curr = el;
			};
		});
...
$(document).ready(function() {
	$("#searchWhere").hover(function() {
		$(this).find("#wherebtn").show();
	}, function() {
		$(this).find("#wherebtn").hide();
	});
	$("#wherebtn li").each(function() {
		var _id_1 = $(this).attr("id"),
			_id_2 = $("#se_id").val();
		if (_id_1 == _id_2) {
			$(this).hide();
		}
		$(this).click(function() {
			var id = $(this).attr("id"),
				txt = $(this).text(),
				pla = $(this).attr("data-role");
			$("#se_id").val(id);
			$("#searchTxt").text(txt);
			$("#key").attr("placeholder", pla);
			$("#key").val("");
			$("#wherebtn").hide();
			$(this).hide().siblings("li").show();
		});
	});
	$("#topSite .curSite span.right").click(function() {
		$("#topSite .siteName").toggle()
	});
	if ($("#Nav").length > 0) {
		$("#Nav").lavaLamp();
	}
	...
	$(".CasesList li").live("mouseover", function() {
		$(this).find(".info").stop().animate({
			top: 0
		}, 300, 'easeInOutBack');
	})
	$(".CasesList li").live("mouseleave", function() {
		var tops = $(this).height();
		$(this).find('.info').stop().animate({
			top: tops
		}, 200, 'easeInOutBack')
	});
	$(".FootSer li,.TeamList li,.CasesList li,.NewsList li,.SpecList li,.ThinkList .ct,.DuizhangList .ct,.HouseList li,.houseDian li,.houseCase li,.houseRes li,.moreTeam li,.tujieList li,.BrandList .imga,.FaqList li").hover(function() {
		$(this).addClass("hover")
	}, function() {
	...
	$(".table input[type='text'],.table textarea").hover(function() {
		$(this).addClass("hover")
	}, function() {
		$(this).removeClass("hover")
	});
	$("#sideFloat li .icon").hover(function() {
	...
	$("#qiyeqq").click(function() {
		$(".onlineBtnText").click();
	});
	var kefu_num = $("#sideFloat .kefu a").length;
	$("#sideFloat li.qq .kefu").css({
		"width": kefu_num * 37,
		"opacity": "0",
		"left": "210%"
	});
	$("#sideFloat li.qq .icon").hover(function() {
		$(this).find(".kefu").css({
			"display": "block"
		}).animate({
			opacity: "1",
	...
	$("#sideFloat li.weixin .img").css({
		"opacity": "0",
		"left": "210%"
	});
	$("#sideFloat li.weixin .icon").hover(function() {
		$(this).find(".img").css({
			"display": "block"
		}).animate({
			opacity: "1",
	...
	var fkefu_num = $("#fKefu .kefu a").length;
	$("#fKefu .kefu").css({
		"width": fkefu_num * 65,
		"opacity": "0",
		"bottom": "95px",
		"margin-left": -(fkefu_num * 65) / 2
	});
	$("#fKefu .box").hover(function() {
		$(this).find(".kefu").css({
			"display": "block"
		}).animate({
			opacity: "1",
	...
	$("#footYouj .weixin").hover(function() {
		$(this).find("img").css({
			"display": "block"
		}).animate({
			opacity: "1",
	...
	$("#footHasMore #viewMore").click(function() {
		$("#footHasMore .even").toggle();
	});
	$(".SpecList #order").click(function() {
		$("#specListInd_bg").show();
		$("#specListInd").show();
	});
	$("#specListInd .ht .close").click(function() {
		$("#specListInd_bg").hide();
		$("#specListInd").hide();
	});
	$(".SpecList #order").each(function(i) {
		$(this).click(function() {
			var id = $(this).attr("value");
			var subject = $(this).attr("name");
			$("#specListInd #spec").val(id);
			$("#specListInd #subject").val(subject);
		});
	});
});;
